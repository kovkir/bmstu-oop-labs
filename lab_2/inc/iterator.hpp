...
template<class Type>
bool Iterator<Type>::operator == (const Iterator<Type> &comparator) const
{   
    check_object(__LINE__);
...
template<class Type>
Type *Iterator<Type>::get_current_ptr() const
{
...
void Iterator<Type>::check_valid_iter(int line) const
{
